	...
	public void action() {
		...
		try {
			if (Starter.Starter.providerCloud == 2) {
				...
				String[] command = { Starter.Starter.vagrant2, Starter.Starter.vagrant3,
						"gcloud compute ssh instancenew" + Starter.Starter.model.getCpuSelected()
								+ " --zone us-central1-c --command='dstat --integer  -cmnd --noheaders --output stats.csv'" };
				System.out.println("gcloud compute ssh instancenew" + Starter.Starter.model.getCpuSelected()
						+ " --zone us-west1-b command 'dstat --integer  -cmnd --noheaders --output stats.csv'");
			...
			if (Starter.Starter.providerCloud == 3) {
				System.out.println("Monitoring");
				String[] command = { Starter.Starter.vagrant2, Starter.Starter.vagrant3,
						"cd MVs/" + Starter.Starter.usuarioMasCloud + " && " + Starter.Starter.vagrant
								+ " ssh -c 'dstat --integer  -cmnd --noheaders --output stats.csv'" };
				System.out.println("cd MVs/" + Starter.Starter.usuarioMasCloud + " " + Starter.Starter.vagrant
						+ " ssh -c 'dstat --integer  -cmnd --noheaders --output stats.csv'");
				// System.out.println(command);
				ProcessBuilder pb = new ProcessBuilder(command);
				p = pb.start();
